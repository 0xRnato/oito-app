  ...
  <v-container fluid fill-height>
    <v-layout justify-center align-center>
      <v-flex text-xs-left style="margin-top: 60px; margin-bottom: 100px;">
        <h1>Termos de Serviço do site Oito App</h1>
        <h3>Condições Gerais</h3>
        <p>Este documento visa estabelecer as responsabilidades, deveres e obrigações que todo USUÁRIO e ANUNCIANTE assumem ao acessar o SITE OITO APP na Internet, sendo complementar aos contratos, termos adicionais e outros documentos firmados diretamente com o USUÁRIO e o ANUNCIANTE. Para os fins destes Termos: SITE OITO APP é o website www.oito.app, de propriedade de OITO ATIVIDADES DE INTERNET S.A., pessoa jurídica de direito privado inscrita no CNPJ/MF sob o nº 10.140.360.0001- 42; USUÁRIO é toda pessoa física ou jurídica que acessa o OITO APP; ANUNCIANTE é toda pessoa física ou jurídica que insere anúncios, oferece serviços ou outro conteúdo no SITE OITO APP.</p>
        <p>O simples acesso e uso do SITE OITO APP configura a total concordância do USUÁRIO e do ANUNCIANTE com os termos, condições e informações a seguir. O SITE OITO APP disponibiliza espaço para a hospedagem de anúncios provenientes de diversos anunciantes (marketplace) e possibilita que USUÁRIOS e ANUNCIANTES comuniquem-se entre si. O SITE OITO APP não atua como prestador ou fornecedor dos serviços anunciados em seu site, ou mesmo de consultoria, supervisão ou ainda intermediário ou participante em nenhum negócio entre o USUÁRIO e o ANUNCIANTE. Dessa forma, o SITE OITO APP não assume responsabilidade por nenhuma consequência que possa advir da relação direta ou indireta estabelecida entre o USUÁRIO e o ANUNCIANTE. O SITE OITO APP não é responsável por qualquer ação ou omissão do ANUNCIANTE baseada nas informações, oferta de serviços, anúncios, fotos, vídeos ou outros materiais inseridos no SITE OITO APP, sendo certo que o SITE OITO APP envida seus melhores esforços para manter o conteúdo sempre atualizado. Não se responsabiliza por imprecisão, erro, fraude, inexatidão ou divergência nos dados, fotos e vídeos ou outros materiais relacionados a anúncios ou à imprecisão das informações aqui contida e se isenta de qualquer responsabilidade pela disponibilidade, pontualidade, segurança ou confiabilidade dos serviços anunciados no SITE OITO APP. Todas as partes envolvidas, inclusive terceiros, se obrigam a eximir o SITE OITO APP, seus funcionários, agentes, representantes e procuradores, de qualquer responsabilização judicial ou extrajudicial que advenha de relação entre USUÁRIOS e ANUNCIANTES. O SITE OITO APP não se responsabiliza, ainda, por eventuais obrigações tributárias ou trabalhistas atinentes a negócios celebrados entre USUÁRIOS e ANUNCIANTES. ANUNCIANTE e USUÁRIO estão cientes de que o conteúdo publicado no SITE OITO APP é público e acessível a terceiros, podendo ser listado nos resultados de ferramentas de pesquisa, que não são de responsabilidade do SITE OITO APP. A empresa proprietária do SITE OITO APP se reserva no direito de modificar, suprimir e/ou ampliar, livremente e a qualquer tempo, sem comunicação prévia o conteúdo, serviços, produtos e outros elementos do SITE OITO APP, ou mesmo encerrar suas atividades sem prévio aviso e sem possibilidade de indenização. O mesmo se aplica ao presente termo de uso, pelo que USUÁRIOS e ANUNCIANTES deverão revê-lo periodicamente.</p>
        <h3>Condições de Uso</h3>
        <p>O SITE OITO APP disponibiliza, exclusivamente para pessoas físicas, espaço para anúncio de serviços, sendo certo que não serão aceitos pedidos de cadastro de pessoas jurídicas como ANUNCIANTES. Aos ANUNCIANTES, o SITE OITO APP, oferece: Cadastro de serviço, cadastro de produtos, Inclusão de fotos/ vídeos, divulgação de serviços/ produtos, chat entre ANUNCIANTE E USUÁRIO e pesquisa de profissionais disponíveis. O ANUNCIANTE que captar um cliente (USUÁRIO) por meio do SITE OITO APP, deverá concluir o serviço por meio do site, sendo vedado que o ANUNCIANTE direcione o USUÁRIO para outros veículos para conclusão do negócio. A comunicação entre ANUNCIANTE e USUÁRIO se dará exclusivamente pelo SITE OITO APP. O SITE OITO poderá iniciar uma cobrança percentual, mediante comunicação prévia, que incidirá sobre o valor total de todo e qualquer negócio celebrado entre ANUNCIANTE e USUÁRIO, que dependerá do formato de contratação entre o SITE OITO APP e o ANUNCIANTE, escolhido por este. O serviço de chat disponibilizado pelo SITE OITO APP permite ao SITE OITO APP acesso a toda comunicação realizada entre ANUNCIANTE e USUÁRIO. O ANUNCIANTE se compromete a fornecer informações verídicas, responsabilizando-se por quaisquer informações veiculadas através de seus dados de login e senha de acesso. O SITE OITO APP recomenda expressamente ao USUÁRIO que:</p>
        <ol>
          <li>
            <p>Verifique cautelosamente toda a documentação e/ou características de qualquer dos produtos ou serviços ofertados antes da conclusão de qualquer negócio, concordando que ao negociar com o ANUNCIANTE dos produtos e serviços ofertados o faz por sua conta e risco.</p>
          </li>
          <li>
            <p>Verifique pessoalmente ou através de alguém de sua confiança qualquer bem ou serviço a ser adquirido e seja cuidadoso com os dados de sua identificação individual sempre que acessar a Internet, informando-os apenas em operações em que exista a proteção de dados.</p>
          </li>
          <li>
            <p>Em caso de preços e condições muito convidativas ou que exijam depósitos prévios, certifique-se quanto a veracidade da informação e confiabilidade do ANUNCIANTE. Cumpre ressaltar que eventuais pagamentos realizados não passam pelo SITE OITO APP, que não se responsabiliza por quaisquer transações financeiras entre USUÁRIOS e ANUNCIANTES;</p>
          </li>
          <li>
            <p>Caso o USUÁRIO acesse outros sites através de links no SITE OITO APP e sejam solicitadas informações pessoais ou financeiras, o SITE OITO APP não possui qualquer responsabilidade sobre o manejo de tais informações.</p>
          </li>
          <li>
            <p>Todos os cuidados devem ser tomados para se proteger de danos, inclusive fraudes ou estelionato on line.</p>
          </li>
        </ol>
        <p>Este SITE OITO APP pode conter hyperlinks para outros portais operados por terceiros. Tais hyperlinks são apenas referenciais, ou seja, o SITE OITO APP não tem controle sobre outros websites e portais da Internet para os quais os hyperlinks redirecionam e não se responsabiliza pelo conteúdo dos mesmos. A inclusão desses hyperlinks não implica na aprovação pelo SITE OITO APP do material ou qualquer associação com seus operadores. Ao acessar e usar esses outros websites - incluindo as informações, materiais, produtos e serviços dos mesmos -, o USUÁRIO estará fazendo-o por sua conta e risco. O mesmo se aplica para portais que possuam hyperlinks para o SITE OITO APP, que, por sua vez, serão permitidos desde que não apresente conteúdo enganoso ou depreciativo. O USUÁRIO poderá acessar, utilizar e imprimir materiais deste SITE OITO APP para seu uso pessoal e não-comercial, contudo não poderá copiar, distribuir, transmitir, exibir, reproduzir, modificar, publicar, licenciar, criar trabalho derivado, colocar e/ou usar em outra página da Internet, transferir ou vender qualquer informação, software, solução tecnológica, lista de USUÁRIOS, produtos ou serviços obtidos no SITE OITO APP, para uso comercial. Esta proibição expressamente inclui, mas não se limita, à prática de screen scraping ou database scraping para obter listas de USUÁRIOS ou outras informações para uso comercial ou não. Mesmo que USUÁRIOS e ANUNCIANTES estejam cientes de que o SITE OITO APP não realiza nenhuma seleção ou pré-aprovação de conteúdo, anunciante ou usuário, esse se reserva o direito de recusar qualquer solicitação de cadastro e de cancelar um cadastro previamente aceito, à seus exclusivos critérios de oportunidade e conveniência, e sem aviso prévio, seja por violação às condições ora expostas ou mesmo por razões de ordem ética, legal ou moral, não cabendo nenhuma indenização ou reparação pelo cancelamento de quaisquer cadastros ou de impossibilidade de cadastro. O SITE OITO APP não permite a USUÁRIOS e ANUNCIANTES:</p>
        <ol>
          <li>
